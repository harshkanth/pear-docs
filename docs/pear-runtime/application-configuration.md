...
`links` can be an object or an array. If it's an object, naming the key makes it easy to reference from [`Pear.config.links`](https://docs.pears.com/api#pearconfiglinks-objectarray)
