...
sidebar_label: Make a Pear Application
sidebar_position: 2
---
...
It continues where [Starting a Pear Desktop Project](https://docs.pears.com/guides/starting-a-pear-desktop-project) left off.
...
![Layout of the app](https://1301247912-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2Fjdab83NqbLtX0WX9qY2n%2Fuploads%2Fgit-blob-1da7fdeab5bdd2f439e35157687df2eb1c39215e%2Fchat-app-3.png?alt=media)
...
> Note that the `pear` dependency is used, even though it was not installed. This is the [Pear API](https://docs.pears.com/pear-runtime/api), available to any Pear project.
...
One option is to copy the code, but it is also possible to distribute the application itself over the DHT. This is the topic of [Sharing a Pear Application](https://docs.pears.com/guides/sharing-a-pear-app).
...
* [Starting a Pear Terminal Project](https://docs.pears.com/guides/starting-a-pear-terminal-project)
* [Sharing a Pear Application](https://docs.pears.com/guides/sharing-a-pear-app)
